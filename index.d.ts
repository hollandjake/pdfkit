...
declare namespace PDFKit.Mixins {
  ...
  interface PDFTable {
    table(opts: Omit<PDFKit.Table.Table, 'data'>): PDFKit.Table.PDFTable;
    table(
      opts: Omit<PDFKit.Table.Table, 'data'> & {
        data: Iterable<Iterable<PDFKit.Table.TableCell>>;
      },
    ): this;
  }
}
...
declare module '@hollandjake/pdfkit/js/data' {
...
declare module '@hollandjake/pdfkit' {
  var doc: PDFKit.PDFDocument;
  export = doc;
}

declare module '@hollandjake/pdfkit/js/gradient' {
  var gradient: {
...
declare module '@hollandjake/pdfkit/js/pattern' {
  var pattern: {
...
declare module '@hollandjake/pdfkit/js/page' {
...
declare module '@hollandjake/pdfkit/js/reference' {
...
declare module '@hollandjake/pdfkit/js/structure_content' {
...
declare module '@hollandjake/pdfkit/js/structure_element' {
  var PDFStructureElement: PDFKit.PDFStructureElement;
  export = PDFStructureElement;
}

declare module '@hollandjake/pdfkit/js/mixins/annotations' {
  var PDFKitAnnotation: PDFKit.Mixins.PDFAnnotation;
  export = PDFKitAnnotation;
}

declare module '@hollandjake/pdfkit/js/mixins/color' {
  var PDFKitColor: PDFKit.Mixins.PDFColor;
  export = PDFKitColor;
}

declare module '@hollandjake/pdfkit/js/mixins/fonts' {
  var PDFKitFont: PDFKit.Mixins.PDFFont;
  export = PDFKitFont;
}

declare module '@hollandjake/pdfkit/js/mixins/images' {
  var PDFKitImage: PDFKit.Mixins.PDFImage;
  export = PDFKitImage;
}

declare module '@hollandjake/pdfkit/js/mixins/text' {
  var PDFKitText: PDFKit.Mixins.PDFText;
  export = PDFKitText;
}

declare module '@hollandjake/pdfkit/js/mixins/vector' {
  var PDFKitVector: PDFKit.Mixins.PDFVector;
  export = PDFKitVector;
}

declare module '@hollandjake/pdfkit/js/mixins/markings' {
  var PDFKitMarking: PDFKit.Mixins.PDFMarking;
  export = PDFKitMarking;
}

declare module '@hollandjake/pdfkit/js/mixins/outline' {
  var PDFKitOutline: PDFKit.Mixins.PDFOutline;
  export = PDFKitOutline;
}

declare namespace PDFKit.Utils {
  /** Measurement of size */
  type Size =
    | number
    | `${number}`
  ...
  type PDFColor = Array<PDFTilingPattern | PDFColor> | string | Array<number>;

  interface Position<T extends Size = Size> {
    x?: T;
    y?: T;
  }
   ...
   */
  type SideDefinition<T> =
    | T
    | undefined
    | [T | undefined, T | undefined]
    | [T | undefined, T | undefined, T | undefined, T | undefined]
    | Partial<{ vertical: T; horizontal: T }>
    | Partial<ExpandedSideDefinition<T>>;

  type ExpandedSideDefinition<T> = { top: T; right: T; bottom: T; left: T };
}

declare namespace PDFKit.Table {
  type Dynamic<T> = (val: number) => T | undefined;

  /** The value of the contents of a cell */
  type TableCellText = any;

  type AlignX = 'left' | 'center' | 'right' | 'justify';
  ...
  interface TableCellStyle {
     ...
     * Defaults to `0.25em`
     */
    padding?: PDFKit.Utils.SideDefinition<PDFKit.Utils.Wideness>;
    /**
     * Controls the thickness of the cells borders.
     *
     * Defaults to `[1, 1, 1, 1]`.
     */
    border?: PDFKit.Utils.SideDefinition<PDFKit.Utils.Wideness>;
    /**
     ...
     */
    borderColor?: PDFKit.Utils.SideDefinition<PDFKit.Utils.PDFColor>;
    /**
     * Font options for the cell
     *
     * Defaults to the documents current font
     */
    font?: PDFKit.Utils.Font;
    /**
     * Set the background color of the cell
     *
     * Defaults to transparent
     */
    backgroundColor?: PDFKit.Utils.PDFColor;
    /**
     ...
     * Defaults to `0`
     */
    textStroke?: PDFKit.Utils.Size;
    /**
     * Sets the text stroke color of the cells content
     *
     * Defaults to `black`
     */
    textStrokeColor?: PDFKit.Utils.PDFColor;
    /**
     * Sets the text color of the cells content
     *
     * Defaults to `black`
     */
    textColor?: PDFKit.Utils.PDFColor;
    /**
  ...
  type TableCell = TableCellText | TableCellStyle;
   ...
   * Defaults to `*`
   */
  type ColumnWidth = PDFKit.Utils.Size | '*';

  interface ColumnStyle extends TableCellStyle {
    width?: ColumnWidth;
    /**
     ...
     * Defaults to `0`
     */
    minWidth?: PDFKit.Utils.Size;
    /**
     * The maximum width of the column
     *
     * Defaults to `undefined` meaning no max
     */
    maxWidth?: PDFKit.Utils.Size;
  }

  type Column = ColumnStyle | ColumnWidth;
   ...
   * Defaults to `auto`
   */
  type RowHeight = PDFKit.Utils.Size | 'auto';

  interface RowStyle extends TableCellStyle {
    height?: RowHeight;
    /**
     ...
     * Defaults to `undefined` meaning no max
     */
    maxHeight?: PDFKit.Utils.Size;
  }

  type Row = RowStyle | RowHeight;

  interface DefaultTableCellStyle
    extends ColumnStyle,
      RowStyle,
      TableCellStyle {}

  type DefaultTableCell = TableCellText | DefaultTableCellStyle;
  ...
  interface Table {
     ...
     */
    position?: PDFKit.Utils.Position;
    /**
     ...
     * Defaults to `auto`
     */
    columnStyles?: Column | Column[] | Dynamic<Column>;
    /**
     ...
     * Defaults to `*`.
     */
    rowStyles?: Row | Row[] | Dynamic<Row>;
    /**
     * Defaults to apply to every cell
     */
    defaultStyle?: DefaultTableCell;
    /**
  ...
  class PDFTable {
    ...
    constructor(document: PDFDocument, opts?: Table);

    /**
     * Render a new row in the table
     */
    row(data: Iterable<TableCell>, lastRow?: boolean): this;
    /**
     * Render a new row in the table
     */
    row(data: Iterable<TableCell>, lastRow: true): PDFDocument;
...
declare module '@hollandjake/pdfkit/js/mixins/table' {
